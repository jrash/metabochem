...
setwd("C:/Users/Vestige/Google Drive/FourchesLab/metabolimics/significant_metabolites")
...
load("C:/Users/Vestige/Google Drive/FourchesLab/metabolimics/training_v_test/training_set_tq_nonormalize.rda")
...
load("C:/Users/Vestige/Google Drive/FourchesLab/metabolimics/training_v_test/test_set_tq_normalize.rda")
d$Set <- paste0(rep("Training", nrow(d)), d$Health_State)
d <- d[, c(1:5, 136, 6:135)]
d_serum <- d[d$Organ == "Serum", ]
d_plasma <- d[d$Organ == "Plasma", ]
...
tiff(paste0("exploratory_analysis/boxplots/serum_",
...
tiff(paste0("exploratory_analysis/boxplots/plasma_",
